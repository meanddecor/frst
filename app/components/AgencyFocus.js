  ...
  return (
    <section className=" py-20 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
      <div className="text-center">
        <h2 className="text-white text-4xl md:text-5xl font-medium leading-tight max-w-4xl mx-auto">
          FRST Subject strictly focuses on developing the next gen of the internet
        </h2>
        <p className="text-gray-400 text-lg leading-relaxed tracking-wider mt-8 max-w-3xl mx-auto">
